import filterSlowCallback from './filter-slow-callback';
...
describe('filterSlowCallback', () => {
  ...
  describe('when passing a valid key|value', () => {
    ...
    it('should return the expected filtered list of breweries', (done) => {
      filterSlowCallback(mockBreweries, key, value, (filteredBreweries) => {
  ...
  describe('when passing an invalid key|value', () => {
    ...
    it('should return the same list of breweries', (done) => {
      filterSlowCallback(mockBreweries, key, value, (filteredBreweries) => {
  ...
  describe('when passing a valid key|value, but an empty list', () => {
    ...
    it('should return an empty list', (done) => {
      filterSlowCallback([], key, value, (filteredBreweries) => {
        expect(filteredBreweries).toEqual([]);
        done();
      });
    });
